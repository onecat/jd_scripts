...
1 0,10,17 * * * jd_bean_sign.js, tag=京东多合一签到
...
async function downFile () {
  ...
  await downloadUrl();
  if ($.body) {
    url = 'https://gh.catmak.name/https://raw.githubusercontent.com/NobyDa/Script/master/JD-DailyBonus/JD_DailyBonus.js';
  } else {
    url = 'https://cdn.staticaly.com/gh/NobyDa/Script/master/JD-DailyBonus/JD_DailyBonus.js';
  }
  try {
    const options = { }
...
function downloadUrl(url = 'https://raw.catmak.name/NobyDa/Script/master/JD-DailyBonus/JD_DailyBonus.js') {
