...
[task_local]
#签到领现金
2 12 * * * jd_cash_Sign.js, tag=签到领现金, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "2 12 * * *" script-path=jd_cash_Sign.js,tag=签到领现金

===============Surge=================
签到领现金 = type=cron,cronexp="2 12 * * *",wake-system=1,timeout=3600,script-path=jd_cash_Sign.js

============小火箭=========
签到领现金 = type=cron,script-path=jd_cash_Sign.js, cronexpr="2 12 * * *", timeout=3600, enable=true
 */
const $ = new Env('签到领现金');
