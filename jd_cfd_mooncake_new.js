/*
京喜财富岛合成月饼
cron 5 2-22/2 * * * jd_cfd_mooncake_new.js
更新时间：2021-9-11
活动入口：京喜APP-我的-京喜财富岛
...
[task_local]
#京喜财富岛合成月饼
5 2-22/2 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_cfd_mooncake_new.js, tag=京喜财富岛合成月饼, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "5 2-22/2 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_cfd_mooncake_new.js,tag=京喜财富岛合成月饼

===============Surge=================
京喜财富岛合成月饼 = type=cron,cronexp="5 2-22/2 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_cfd_mooncake_new.js

============小火箭=========
京喜财富岛合成月饼 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_cfd_mooncake_new.js, cronexpr="5 2-22/2 * * *", timeout=3600, enable=true
 */
