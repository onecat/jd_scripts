...
let shareCodes = ['f3657ef9e87c4e0ca9cc2a4c513e47a9','45b2ce9b0f6940f798d14fa3a9a66ae9']
...
function readShareCode() {
  return new Promise(async resolve => {
    $.get({url: `http://share.jdym.cc/api/v3/farm/query/${randomCount}/`, timeout: 10000}, (err, resp, data) => {
      try {
        if (err) {
          console.log(JSON.stringify(err))
