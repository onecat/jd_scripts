...
活动地址：https://anmp.jd.com/babelDiy/Zeus/dfoVj56tKdBbxaAi1fzE9KktMDx/index.html
活动入口：京东app-女装馆-赢京豆
...
!(async () => {
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      ...
      try {
        await jdMh('https://anmp.jd.com/babelDiy/Zeus/dfoVj56tKdBbxaAi1fzE9KktMDx/index.html')
      } catch (e) {
        $.logErr(e)
      }
    }
