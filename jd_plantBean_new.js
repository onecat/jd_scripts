/*
种豆得豆 脚本更新地址：https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_plantBean_new.js
更新时间：2021-04-9
...
=====================================Quantumult X=================================
[task_local]
21 8-20/4 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_plantBean_new.js, tag=种豆得豆, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdzd.png, enabled=true

=====================================Loon================================
[Script]
cron "21 8-20/4 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_plantBean_new.js,tag=京东种豆得豆

======================================Surge==========================
京东种豆得豆 = type=cron,cronexp="21 8-20/4 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_plantBean_new.js

====================================小火箭=============================
京东种豆得豆 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_plantBean_new.js, cronexpr="21 8-20/4 * * *", timeout=3600, enable=true
...
let shareCodes = ['uc5ee56qxvx677xhxmbk6jjw36jrts764cphmxi','mlrdw3aw26j3xqgnnbrrkezt3tym2ihxrjzw7jy']
let allMessage = ``;
...
function readShareCode() {
  return new Promise(async resolve => {
    $.get({url: `http://share.jdym.cc/api/v3/bean/query/${randomCount}/`, timeout: 10000}, (err, resp, data) => {
      try {
        if (err) {
